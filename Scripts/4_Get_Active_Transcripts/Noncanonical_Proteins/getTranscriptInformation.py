...
class getTranscriptInformation:
	...
	def getTranscriptsRegionsInformation(self, infoTranscript):
		...
		transcriptName = infoTranscript[0][0]
		...
		for index, exon in enumerate(infoTranscript):
			...
			if index != 0 :
				...
				if strandTranscript == '-' :
					...
					sequenceTranscriptPositions = rangePositions + sequenceTranscriptPositions
		...
		return [regionTranscript, sequenceTranscript, sequenceTranscriptPositions, transcriptName, chromosomeTranscript]
